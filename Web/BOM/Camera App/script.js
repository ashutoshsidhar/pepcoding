...
let mediaRecorder;
let zoom = 1;
let remfill =  document.querySelector("#remove-filter");
remfill.addEventListener("click",function(){
    removeFilter();
})
...
vidRecordBtn.addEventListener("click", function () {
    if (!recordState) {
        mediaRecorder.start();
        recordState = true;
        document.querySelector(".recording-status").innerText = "radio_button_checked";
        ...
        vidRecordBtn.style.color = "red";
        vidRecordBtn.innerText = "stop_circle";
    } else {
        mediaRecorder.stop();
        recordState = false;
        ...
        second = 0;
        minute = 0;
        document.querySelector(".recording-status").innerText = "radio_button_unchecked";
        document.querySelector(".minute").innerText = "00";
        document.querySelector(".second").innerText = "00";
        vidRecordBtn.style.color = "white";
        vidRecordBtn.innerText = "video_camera_front";
    }
});
