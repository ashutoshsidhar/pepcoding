...
function addLoader() {
    $(".container").append(`<div class="sheet-modal-parent loader-parent">
                                    <div class="loading-img"><img src="https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/2c110454-5b33-4416-bf9b-72992c7cb56f/d60eb1v-79212624-e842-4e55-8d58-4ac7514ca8e4.gif?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..9LDpLmLlbA507H7fKa8aEDxFr8k3SlwCGC1zuJ13d1w"/>
                            </div>`);
}
...
function renameSheet() {
    ...
    if(newSheetName ) {
        ...
        $(".sheet-modal-input-container").append(`
            <div class="error"> Sheet already exists! </div>
        `);
    } 
    else {
        $(".sheet-modal-input-container").append(`
            <div class="error"> Enter Sheet Name! </div>
        `);
    }
}
