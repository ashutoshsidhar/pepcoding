...
public class l001Basic {
    ...
    public static int fibo_memo(int n, int[] dp) { // memorization method DP
        if (n <= 1) {
            return dp[n] = n;
        }
    ...
    public static int fibo_DP(int N, int[] dp) { // Tabulisation method DP
        for (int n = 0; n <= N; n++) {
            if (n <= 1) {
                dp[n] = n;
                continue;
    ...
    public static int fibo_Opti(int n) { // Optimisation method DP
        int a = 0, b = 1;
        for (int i = 0; i < n; i++) {
            System.out.print(a + " ");
            int sum = a + b;
    ...
    public static void fibo() { // step 2
        int n = 6;
        int[] dp = new int[n + 1];
        fibo_DP(n, dp);
